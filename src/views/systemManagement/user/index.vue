    ...
    <div class="word_header">
      ...
      <div class="header_left">
        <div class="store_header">
          ...
          <div>
            状态：
            <el-select v-model="statusText" placeholder="请选择状态" @change="changeStatusText">
              <el-option
        ...
        <div class="store_header">
          ...
          <div class="header_vip_status">
            部门：
            <el-select v-model="branch" placeholder="请选择部门" @change="searchBranchVal">
                <el-option v-for="(item,index) in branchListMes" :key="index" :label="item.name" :value="item.id"></el-option>
            </el-select>
          </div>
          <div class="header_vip_status">
            性别：
            <el-select v-model="sexText" placeholder="请选择性别" @change="changeSexText">
              <el-option
        ...
        <el-dialog title="新增用户" :visible.sync="dialogFormVisible">
          ...
          >
            ...
            <el-form-item label="角色" prop="role">
              <el-select v-model="ruleForm.role" placeholder="请选择角色" @change="roleVal">
                <el-option v-for="(item,index) in roleListMes" :key="index" :label="item.roleName" :value="item.roleId"></el-option>
                
              </el-select>
            </el-form-item>
            <el-form-item label="部门" prop="branch">
              <el-select v-model="ruleForm.branch" placeholder="请选择部门" @change="branchVal">
                <el-option v-for="(item,index) in branchListMes" :key="index" :label="item.name" :value="item.id"></el-option>
              </el-select>
            </el-form-item>
...
<script>
import { getUser, roleList, branchList, addUser } from "@/api/http.js";
export default {
  data() {
    return {
      createtime: ["", ""],
